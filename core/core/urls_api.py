...
########################параметры##################################################
    ...
    path('parameters/class/<int:classifier_node_id>/', api_views.api_parameters_for_class,
         name='api_parameters_for_class'),
    ...
    path('products/class/<int:classifier_node_id>/with-params/', api_views.api_products_with_params,
         name='api_products_with_params'),
    path('products/class/<int:classifier_node_id>/filter/', api_views.api_filter_products_by_params,
         name='api_filter_products_by_params'),
]
